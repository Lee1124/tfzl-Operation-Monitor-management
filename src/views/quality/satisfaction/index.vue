...
//服务满意度
<template>
  <div class="satisfaction" style="height:100%;">
    <!-- 面包屑 -->
      ...
      <div class="pc-content-container scrollbarStyle2">
        <div class="search-view">
          ...
          <div class="search-filter">
            ...
            <select-one class="search-btn" labelText="医务人员" :options="options" />
            <select-one class="search-btn" labelText="评价类型" :options="options" />
          </div>
          <!-- 查询按钮 -->
        ...
        <div id="satisfactionPrint" class="_marginTopFu" style="width:100%;">
          <div class="satisfactionPrint">
            <div class="_title">2019/01/01至2019/12/31服务满意度统计</div>
            <!-- 表格渲染 -->
            <el-table
              :data="tableData"
              show-summary
            ...
            >
              ...
              <el-table-column prop="willPay" label="总评价数"></el-table-column>
              <el-table-column prop="willPay" label="护理差评数"></el-table-column>
              <el-table-column prop="willPay" label="在线问诊差评数"></el-table-column>
              <el-table-column prop="willPay" label="服务满意度"></el-table-column>
            </el-table>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    doPrint() {
      openPrint(this, "#satisfactionPrint", "服务满意度打印");
    }
  }
};
</script>
