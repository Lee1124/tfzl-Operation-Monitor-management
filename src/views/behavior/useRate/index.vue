...
//抗菌药物使用率
<template>
  <div class="useRate" style="height:100%;">
    <!-- 面包屑 -->
    ...
    <div class="pc-content">
      <div class="pc-content-container scrollbarStyle2">
        ...
        <div class="order-table _marginTopFu" id="useRatePrint" style="width:100%;">
          <div class='useRatePrint'>
            <!-- 标题 -->
            <div class="_title">2019/01/01至2019/12/31抗菌药物使用率统计</div>
            <!-- 表格渲染 -->
            <el-table
              :data="tableData"
              show-summary
            ...
            >
              ...
              <el-table-column prop="willPay" label="就诊使用抗菌药物人次"></el-table-column>
              <el-table-column prop="willPay" label="就诊人次"></el-table-column>
              <el-table-column prop="willPay" label="使用率"></el-table-column>
            </el-table>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    doPrint() {
      openPrint(this,"#useRatePrint",'抗菌药物使用率打印');
    }
  }
};
</script>
