...
<template>
  ...
  >
    ...
    <el-table-column prop="acceptNurse" label="接单护士" show-overflow-tooltip></el-table-column>
    <el-table-column prop="doctor" label="上门护士" show-overflow-tooltip></el-table-column>
    ...
    <el-table-column prop="projectName" label="护理项目" show-overflow-tooltip></el-table-column>
    <el-table-column prop="patient" label="护理对象" show-overflow-tooltip></el-table-column>
