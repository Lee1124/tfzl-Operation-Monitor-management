        ...
        <div class="inquiryPrint1">
          ...
          >
            ...
            <el-table-column label="订单数量">
              ...
              <el-table-column prop="unReceived" label="待服务"></el-table-column>
              <el-table-column prop="inConsultation" label="服务中"></el-table-column>
              <el-table-column label="已完成">
                ...
                <el-table-column prop="refund" label="退单"></el-table-column>
              </el-table-column>
