    ...
    <div class="content" id="registerDetailsPrint" style="height:100%;">
      <div class="registerDetailsPrint">
        ...
        >
          ...
          <el-table-column prop="patientName" label="性别" show-overflow-tooltip></el-table-column>
          <el-table-column prop="patientName" label="年龄" show-overflow-tooltip></el-table-column>
