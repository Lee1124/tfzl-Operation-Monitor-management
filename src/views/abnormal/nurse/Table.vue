...
<template>
  ...
  >
    ...
    <el-table-column prop="overTime" label="接单超时" show-overflow-tooltip>
      <template slot-scope="scope">
        <span style="color:#ff3939;" v-if="scope.row.eventType===3">{{ scope.row.timeOut}}</span>
      </template>
    </el-table-column>
    <el-table-column prop="overTime2" label="接收超时" show-overflow-tooltip>
      <template slot-scope="scope">
        <span style="color:#ff3939;" v-if="scope.row.eventType===5">{{ scope.row.timeOut}}</span>
      </template>
    </el-table-column>
    <el-table-column prop="overTime2" label="上门超时" show-overflow-tooltip>
      <template slot-scope="scope">
        <span style="color:#ff3939;" v-if="scope.row.eventType===5">{{ scope.row.timeOut}}</span>
      </template>
    </el-table-column>
    ...
    <el-table-column prop="doctorName" label="上门护士" show-overflow-tooltip></el-table-column>
